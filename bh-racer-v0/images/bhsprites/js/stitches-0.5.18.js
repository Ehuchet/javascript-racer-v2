    ...
    var S = window.Stitches = (function () {
        ...
        return {
            ...
            makeStylesheet: function (placedIcons, sprite) {
                ...
                // bh: omit main background image style rule
                var css = [];
                //var css = ["var SPRITES = {"];
                //var css = [
                //    "." + prefix + " {",
                ...
                $(placedIcons).each(function (idx, icon) {
                    // bh: change format to json object suitable for pasting into js code
                    var newname = icon.name.toUpperCase();
                    newname = newname.substring(0, newname.indexOf('-PNG'));
                    //css = css.concat([ newname + ": { x:" + icon.x + ", y:" + icon.y + ", w: " + icon.image.width + ", h:" + icon.image.height + "},"]);
                    css.push( newname + ": { x:" + icon.x + ", y:" + icon.y + ", w: " + icon.image.width + ", h:" + icon.image.height + "}" );
                    //css = css.concat([
                    //    "." + prefix + "-" + icon.name + " {",
                ...
                var data = "data:text/plain," + encodeURIComponent("var SPRITES = {\n" + css.join(",\n") + "\n};");
